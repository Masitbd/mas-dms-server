...
const changePasswordByAdmin = async (
  ...
  const result = await User.findOneAndUpdate(
    { uuid: id },
    {
      password: await bcrypt.hash(data.password, Number(config.salt)),
    }
  );
