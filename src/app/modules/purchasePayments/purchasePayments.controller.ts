...
const createPurchasePayment = catchAsync(async (req: Request, res: Response) => {
...
const getAllPurchasePayments = catchAsync(async (req: Request, res: Response) => {
...
const getSinglePurchasePayment = catchAsync(async (req: Request, res: Response) => {
  const { id } = req.params;
...
const updatePurchasePayment = catchAsync(async (req: Request, res: Response) => {
  const { id } = req.params;
  const { ...updatedData } = req.body;
  const result = await PurchasePaymentService.updatePurchasePayment(id, updatedData);
...
const deletePurchasePayment = catchAsync(async (req: Request, res: Response) => {
  const { id } = req.params;
